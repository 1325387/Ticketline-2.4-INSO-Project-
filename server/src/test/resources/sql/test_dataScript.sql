...
---------------------------------- Gallery --------------------------------
BEGIN TRANSACTION
INSERT INTO gallery(id, description, name, sequence) VALUES (1, 'a gallery', 'A', 1);
INSERT INTO gallery(id, description, name, sequence) VALUES (2, 'a gallery', 'B', 1);
INSERT INTO gallery(id, description, name, sequence) VALUES (3, 'a gallery', 'C', 1);
COMMIT
------------------------------------ Location --------------------------------
BEGIN TRANSACTION
...
INSERT INTO location(id, city, country, postalcode, street, description, name, owner) VALUES (2, 'Vienna', 'a country', '1100', 'a street', 'a description', 'location 1', 'a owner');
INSERT INTO location(id, city, country, postalcode, street, description, name, owner) VALUES (3, 'Vienna', 'a country', '1200', 'a street', 'a description', 'location 1', 'a owner');
INSERT INTO location(id, city, country, postalcode, street, description, name, owner) VALUES (4, 'Berlin', 'a country', '81006', 'a street', 'a description', 'location 1', 'a owner');
...
------------------------------------ Seat -----------------------------------
BEGIN TRANSACTION
INSERT INTO seat(id, name, description, sequence, category_id, row_id, gallery_id, room_id) VALUES (1, 'seat 1', 'a description', 1, 1, 1, 1, 1);
INSERT INTO seat(id, name, description, sequence, category_id, row_id, gallery_id, room_id) VALUES (2, 'seat 2', 'a description', 2, 1, 2, 1, 1);
INSERT INTO seat(id, name, description, sequence, category_id, row_id, gallery_id, room_id) VALUES (3, 'seat 3', 'a description', 1, 1, 1, 1, 2);
INSERT INTO seat(id, name, description, sequence, category_id, row_id, gallery_id, room_id) VALUES (4, 'seat 4', 'a description', 2, 1, 1, 2, 2);
INSERT INTO seat(id, name, description, sequence, category_id, row_id, gallery_id, room_id) VALUES (5, 'seat 5', 'a description', 3, 1, 1, 3, 2);
COMMIT
----------------------------------- Performance  -----------------------------------
BEGIN TRANSACTION
...
---------------------------------- Customer -----------------------------------
BEGIN TRANSACTION
INSERT INTO customer(id, firstname, lastname) VALUES (1, 'Anonymous', 'Anonymous');
INSERT INTO customer(id, firstname, lastname) VALUES (2, 'Anthony', 'Stark');
INSERT INTO customer(id, firstname, lastname) VALUES (3, 'Jane', 'May');
INSERT INTO customer(id, firstname, lastname) VALUES (4, 'Martin', 'Obermayer');
COMMIT
----------------------------------Employee-------------------------------------
BEGIN TRANSACTION
INSERT INTO employee(id, firstname, lastname) VALUES (1, 'vor', 'nach');
COMMIT

------------------------------------Reservation ----------------------------
BEGIN TRANSACTION
INSERT INTO reservation(id, customer_id, employee_id) VALUES (1,1,1);
COMMIT
----------------------------------- TicketIdentifier  --------------------------
BEGIN TRANSACTION
INSERT INTO ticketidentifier(id, valid, ticket_id) VALUES (1, true, 1);
INSERT INTO ticketidentifier(id, valid, reservation_id, ticket_id) VALUES (2, true, 1, 2);
COMMIT

----------------------------------- Receipt --------------------------
BEGIN TRANSACTION
INSERT INTO receipt(id, customer_id, employee_id) VALUES (1, 1, 1);
COMMIT

----------------------------------- Receiptentry  --------------------------
BEGIN TRANSACTION
INSERT INTO receiptentry(id, amount, position, unitprice, receipt_id, ticketidentifier_id) VALUES (1, 1, 1, 5, 1, 1);
COMMIT
