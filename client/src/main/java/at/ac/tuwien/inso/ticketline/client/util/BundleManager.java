...
public class BundleManager {
    ...
    private static final String MESSAGES_BASENAME = "localization.ticketlineClientMessages";

    private static Locale LOCALE = Locale.getDefault();

    private static final Map<String, ResourceBundle> BUNDLES = new HashMap<>();
    private static final Map<String, ResourceBundle> EXCEPTION_BUNDLES = new HashMap<>();
    private static final Map<String, ResourceBundle> MESSAGES_BUNDLES = new HashMap<>();
    ...
    static {
        supportedLocales.forEach(locale -> {
            ...
            MESSAGES_BUNDLES.put(locale.getLanguage(), ResourceBundle.getBundle(MESSAGES_BASENAME, locale, new UTF8Control()));
    ...
    public static ResourceBundle getMessageBundle() {
        return MESSAGES_BUNDLES.getOrDefault(LOCALE.getLanguage(), MESSAGES_BUNDLES.get(supportedLocales.get(0).getLanguage()));
    }
