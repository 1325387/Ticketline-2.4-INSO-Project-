...
public class DataGeneratorMain implements ApplicationContextAware {
    ...
    public void generateData() {
        ...
        context.getBean(RowGenerator.class).generate();
        context.getBean(GalleryGenerator.class).generate();
        context.getBean(CategoryGenerator.class).generate();
        ...
        context.getBean(LocalStorageGenerator.class).generate();
